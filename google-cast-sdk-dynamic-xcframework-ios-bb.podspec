Pod::Spec.new do |s|
    s.name = 'google-cast-sdk-dynamic-xcframework-ios-bb'
    s.version = '4.8.0'
    s.license = {
      type: 'Commercial',
    ...
    s.summary = 'Framework for casting content to Google Cast devices (dynamically-linked version as xcframework)'
    ...
    s.source = {
      http: 'https://dl.google.com/dl/chromecast/sdk/ios/GoogleCastSDK-ios-4.8.0_dynamic_xcframework.zip'
    }
    s.platform = :ios, '13.0'
    s.vendored_frameworks = 'GoogleCastSDK-ios-4.8.0_dynamic_xcframework/GoogleCast.xcframework'
end
